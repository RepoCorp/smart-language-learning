...
export const GERMAN_PHRASE_GRAMMAR_FEATURE_PRESENTATION = {
  ...
  time_expression_position: { title: "strategies.grammar.timeExpressionPosition", present: "strategies.grammar.timeExpressionPositionNote", example: <><span>Ich gehe <strong>heute</strong> zur Arbeit.</span> · <span><strong>Heute</strong> <strong>gehe</strong> ich zur Arbeit.</span></> },
  ...
  perfect_with_haben_or_sein: { title: "strategies.grammar.perfectWithHabenOrSein", present: "strategies.grammar.perfectWithHabenOrSeinNote", example: <><span>machen → Ich <strong>habe</strong> das <strong>gemacht</strong>.</span> · <span>gehen → Ich <strong>bin</strong> nach Hause <strong>gegangen</strong>.</span></> },
