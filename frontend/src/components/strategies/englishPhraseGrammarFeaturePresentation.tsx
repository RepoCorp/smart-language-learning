...
export const ENGLISH_PHRASE_GRAMMAR_FEATURE_PRESENTATION = {
  ...
  english_third_person_s: {
    ...
    example: <><span>I work. → She work<strong>s</strong>.</span> · <span>I watch. → He watch<strong>es</strong>.</span></>,
  },
  english_be_conjugation: {
    title: "strategies.grammar.beConjugation",
    present: "strategies.grammar.beConjugationNote",
    example: <><span>I <strong>am</strong></span> · <span>you <strong>are</strong></span> · <span>she <strong>is</strong></span></>,
  },
  english_do_question: {
    title: "strategies.grammar.doQuestion",
    present: "strategies.grammar.doQuestionNote",
    example: <><span>You work. → <strong>Do</strong> you work?</span> · <span>She works. → <strong>Does</strong> she work?</span></>,
  },
  english_do_negation: {
    title: "strategies.grammar.doNegation",
    present: "strategies.grammar.doNegationNote",
    example: <><span>I know. → I <strong>do not know</strong>.</span> · <span>She knows. → She <strong>does not know</strong>.</span></>,
  },
  english_wh_question: {
    title: "strategies.grammar.whQuestion",
    present: "strategies.grammar.whQuestionNote",
    example: <><span><strong>Where</strong> do you live?</span> · <span><strong>What</strong> do you want?</span> · <span><strong>Why</strong> are you here?</span></>,
  },
  english_modal_base_verb: {
    title: "strategies.grammar.modalBaseVerb",
    present: "strategies.grammar.modalBaseVerbNote",
    example: <><span>can + swim → I <strong>can swim</strong>.</span> · <span>should + go → You <strong>should go</strong>.</span></>,
  },
  english_present_continuous: {
    title: "strategies.grammar.presentContinuous",
    present: "strategies.grammar.presentContinuousNote",
    example: <><span>work → I <strong>am working</strong>.</span> · <span>sleep → She <strong>is sleeping</strong>.</span></>,
  },
  english_simple_past: {
    title: "strategies.grammar.simplePast",
    present: "strategies.grammar.simplePastNote",
    example: <><span>work → I <strong>worked</strong> yesterday.</span> · <span>go → I <strong>went</strong> home.</span></>,
  },
  english_past_continuous: {
    title: "strategies.grammar.pastContinuous",
    present: "strategies.grammar.pastContinuousNote",
    example: <><span>work → I <strong>was working</strong>.</span> · <span>sleep → They <strong>were sleeping</strong>.</span></>,
  },
  english_present_perfect: {
    title: "strategies.grammar.presentPerfect",
    present: "strategies.grammar.presentPerfectNote",
    example: <><span>see → I <strong>have seen</strong> it.</span> · <span>finish → She <strong>has finished</strong>.</span></>,
  },
  english_future_will: {
    title: "strategies.grammar.futureWill",
    present: "strategies.grammar.futureWillNote",
    example: <><span>call → I <strong>will call</strong> you.</span> · <span>come → She <strong>will come</strong> tomorrow.</span></>,
  },
  english_infinitive_with_to: {
    title: "strategies.grammar.infinitiveWithTo",
    present: "strategies.grammar.infinitiveWithToNote",
    example: <><span>go → I want <strong>to go</strong>.</span> · <span>learn → I need <strong>to learn</strong>.</span></>,
  },
  english_gerund_after_verb: {
    title: "strategies.grammar.gerundAfterVerb",
    present: "strategies.grammar.gerundAfterVerbNote",
    example: <><span>enjoy + read → I enjoy <strong>reading</strong>.</span> · <span>avoid + drive → I avoid <strong>driving</strong>.</span></>,
  },
  english_article_a_an: {
    title: "strategies.grammar.articleAAn",
    present: "strategies.grammar.articleAAnNote",
    example: <><span><strong>a</strong> dog</span> · <span><strong>an</strong> apple</span></>,
  },
  english_subject_pronoun_required: {
    ...
    example: <><span><strong>I</strong> work.</span> · <span><strong>She</strong> lives here.</span> · <span><strong>It</strong> is raining.</span></>,
  },
  english_countable_uncountable: {
    ...
    example: <><span><strong>a book</strong></span> · <span><strong>two books</strong></span> · <span><strong>some water</strong></span></>,
  },
  english_adjective_noun_order: {
    title: "strategies.grammar.adjectiveNounOrder",
    present: "strategies.grammar.adjectiveNounOrderNote",
    example: <><span>a <strong>red</strong> car</span> · <span>a <strong>big</strong> house</span></>,
  },
  english_comparative: {
    title: "strategies.grammar.comparative",
    present: "strategies.grammar.comparativeNote",
    example: <><span>small → small<strong>er</strong></span> · <span>interesting → <strong>more</strong> interesting</span> · <span>good → <strong>better</strong></span></>,
  },
  english_superlative: {
    title: "strategies.grammar.superlative",
    present: "strategies.grammar.superlativeNote",
    example: <><span>small → <strong>the smallest</strong></span> · <span>interesting → <strong>the most interesting</strong></span> · <span>good → <strong>the best</strong></span></>,
  },
