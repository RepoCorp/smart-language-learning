...
const messages = {
  en: {
    ...
    "strategies.grammar.verbPositionStatementNote": "The conjugated verb comes in the second position.",
    "strategies.grammar.verbPositionYesNoQuestionNote": "The conjugated verb comes in the first position.",
    "strategies.grammar.verbPositionWQuestionNote": "The conjugated verb comes directly after the question word.",
    "strategies.grammar.verbPositionSubordinateClauseNote": "The conjugated verb comes at the end of the subordinate clause.",
    "strategies.grammar.separableVerbMainClauseNote": "The verb stem comes early, while its prefix moves to the end.",
    "strategies.grammar.modalVerbWithInfinitiveNote": "The modal verb is conjugated, and the other verb stays in the infinitive at the end.",
    "strategies.grammar.reflexiveVerbNote": "The reflexive pronoun refers back to the subject.",
  ...
  es: {
    ...
    "strategies.grammar.verbPositionStatementNote": "El verbo conjugado está en la segunda posición.",
    "strategies.grammar.verbPositionYesNoQuestionNote": "El verbo conjugado está en la primera posición.",
    "strategies.grammar.verbPositionWQuestionNote": "El verbo conjugado va justo después de la palabra interrogativa.",
    "strategies.grammar.verbPositionSubordinateClauseNote": "El verbo conjugado va al final de la oración subordinada.",
    "strategies.grammar.separableVerbMainClauseNote": "La raíz del verbo aparece antes y su prefijo se mueve al final.",
    "strategies.grammar.modalVerbWithInfinitiveNote": "El verbo modal se conjuga y el otro verbo queda en infinitivo al final.",
    "strategies.grammar.reflexiveVerbNote": "El pronombre reflexivo se refiere al sujeto.",
