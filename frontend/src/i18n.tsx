...
const messages = {
  en: {
    ...
    "session.previousTestedItem": "Previous tested item",
    "session.restorePreviousFailed": "Failed to reopen the previous tested item",
  ...
  es: {
    ...
    "session.previousTestedItem": "Elemento probado anterior",
    "session.restorePreviousFailed": "No se pudo reabrir el elemento probado anterior",
