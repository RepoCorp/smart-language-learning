...
const messages = {
  en: {
    ...
    "session.typeLabel": "Session type",
    "session.typeStandard": "Regular session",
    "session.typeStandardBadge": "Core",
    "session.typeStandardDescription": "Review the planned mix of due, new, and upcoming items.",
    "session.typeDifficult": "Difficult items ({count})",
    "session.typeDifficultDescription": "Two-step follow-up practice for the items that recently gave trouble.",
    "session.typeStandardActive": "Regular session",
    "session.typeDifficultActive": "Difficult items session",
    ...
    "session.startDifficultButton": "Start difficult session",
    ...
    "dialogs.loadingMore": "Loading more dialogs...",
    "dialogs.loadMore": "Load more dialogs",
    "dialogs.topicFilter": "Filter by topic",
    "dialogs.topicFilterPlaceholder": "Topic",
  ...
  es: {
    ...
    "session.typeLabel": "Tipo de sesión",
    "session.typeStandard": "Sesión normal",
    "session.typeStandardBadge": "Base",
    "session.typeStandardDescription": "Repasa la mezcla planificada de elementos pendientes, nuevos y próximos.",
    "session.typeDifficult": "Elementos difíciles ({count})",
    "session.typeDifficultDescription": "Práctica extra en dos pasos para los elementos que dieron más problema.",
    "session.typeStandardActive": "Sesión normal",
    "session.typeDifficultActive": "Sesión de elementos difíciles",
    ...
    "session.startDifficultButton": "Iniciar sesión difícil",
    ...
    "dialogs.loadingMore": "Cargando más diálogos...",
    "dialogs.loadMore": "Cargar más diálogos",
    "dialogs.topicFilter": "Filtrar por tema",
    "dialogs.topicFilterPlaceholder": "Tema",
