...
const messages = {
  en: {
    ...
    "session.newWordsCelebrationKicker": "FIVE NEW WORDS",
    "session.newWordsCelebrationTitle": "Five new words down. That counts.",
    "session.newWordsCelebrationMessage": "You just pushed another batch of 5 new words into motion. Take the tiny victory lap, then keep going.",
  ...
  es: {
    ...
    "session.newWordsCelebrationKicker": "CINCO PALABRAS NUEVAS",
    "session.newWordsCelebrationTitle": "Cinco palabras nuevas completadas. Eso cuenta.",
    "session.newWordsCelebrationMessage": "Acabas de poner en marcha otro bloque de 5 palabras nuevas. Mini vuelta de victoria y seguimos.",
