  ...
  en: {
    ...
    steps: [
      ...
      },
      {
        ...
        target: "main-menu",
        route: "/configurations",
        title: "Open the menu and go to Create Content",
        body: "Open the menu, then click Create Content. This is where you transform your own interests into dialogs to learn from.",
      ...
      },
      {
        ...
        target: "main-menu",
        route: "/content/create",
        title: "Open the menu and go to Session",
        body: "Open the menu, then click Session. This is where the actual learning practice happens.",
      ...
      },
      {
        ...
        route: "/session",
        title: "Practice one item at a time",
        body: "Use the exercises, then choose whether the item felt right or wrong. You can keep using this simple loop: create content, save what matters, and learn through sessions.",
        moreInfoLabel: "More information",
        moreInfo: "Exercises vary depending on what you saved. You may hear an item, recognize its meaning, build it from pieces, or practice it in the other language direction. Each format strengthens a different part of understanding and using the language.",
        waitingBody: "Start a session first. Your first practice item will appear here.",
      },
    ],
    next: "Next",
    finish: "Finish for now",
    skip: "Continue later",
    completeTitle: "Your setup is ready",
    completeBody: "You now know the basic learning loop: create content, save what matters, and practice it in a session.\n\nAfter you complete a test, the Open details button appears below it. Use it to explore the item further and try more ways of practicing it. We will not cover those now, so feel free to explore on your own.\n\nOpen Configuration whenever you want to replay this tutorial or continue with more tutorials.",
  },
  es: {
    ...
    steps: [
      ...
      },
      {
        ...
        target: "main-menu",
        route: "/configurations",
        title: "Abre el menú y ve a Crear contenido",
        body: "Abre el menú y después haz clic en Crear contenido. Ahí conviertes tus propios intereses en diálogos para aprender.",
        advanceWhenRoute: "/content/create",
        hideNext: true,
      },
      {
      ...
      },
      {
        ...
        target: "main-menu",
        route: "/content/create",
        title: "Abre el menú y ve a Sesión",
        body: "Abre el menú y después haz clic en Sesión. Ahí ocurre la práctica de aprendizaje de verdad.",
        advanceWhenRoute: "/session",
        hideNext: true,
      },
      {
      ...
      },
      {
        ...
        target: "session-current-item",
        route: "/session",
        title: "Practica un elemento cada vez",
        body: "Haz los ejercicios y luego elige si sentiste que lo sabías o no. Puedes seguir usando este ciclo sencillo: crear contenido, guardar lo importante y aprender en las sesiones.",
        moreInfoLabel: "Más información",
        moreInfo: "Los ejercicios cambian según lo que hayas guardado. Puedes escuchar un elemento, reconocer su significado, construirlo por partes o practicarlo en la otra dirección del idioma. Cada formato fortalece una parte distinta de comprender y usar el idioma.",
        waitingBody: "Primero empieza una sesión. Tu primer elemento de práctica aparecerá aquí.",
      },
    ],
    next: "Siguiente",
    finish: "Terminar por ahora",
    skip: "Continuar más tarde",
    completeTitle: "Tu configuración está lista",
    completeBody: "Ya conoces el ciclo básico: crear contenido, guardar lo importante y practicarlo en una sesión.\n\nDespués de completar una prueba, aparece el botón Abrir detalles debajo. Úsalo para explorar más el elemento y probar otras formas de practicarlo. No vamos a explicarlas ahora, así que siéntete libre de explorar por tu cuenta.\n\nAbre Configuración cuando quieras repetir este tutorial o continuar con más tutoriales.",
  },
};
