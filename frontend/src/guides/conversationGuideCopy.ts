  ...
  en: {
    ...
    steps: [
      ...
      },
      {
        ...
        body: "The goal gives the conversation a simple direction. Generate one, and regenerate it if it does not feel useful for your topic. If it feels too difficult, you can change the difficulty before creating another one.\n\nAs you talk, your conversation partner quietly checks whether you have achieved the goal using the language you are learning. Once you do, the conversation will naturally begin to come to a close.\n\nIf you have not reached it yet, the conversation partner will gently keep the conversation going, with a relevant question or invitation to help you keep practicing.",
        hideNext: true,
  ...
  es: {
    ...
    steps: [
      ...
      },
      {
        ...
        body: "El objetivo le da una dirección sencilla a la conversación. Genera uno y regenéralo si no te parece útil para tu tema. Si te parece demasiado difícil, puedes cambiar la dificultad antes de generar otro.\n\nMientras hablas, tu compañero de conversación comprueba discretamente si has alcanzado el objetivo usando el idioma que estás aprendiendo. Cuando lo consigues, la conversación empieza a llegar a su fin de forma natural.\n\nSi todavía no lo has alcanzado, tu compañero de conversación seguirá la conversación con suavidad, con una pregunta o invitación relevante que te ayude a seguir practicando.",
        hideNext: true,
        advanceOnAction: "conversation-goal-generated",
      },
      {
