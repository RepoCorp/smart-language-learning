...
MIDDLEWARE = [
    "config.healthcheck_middleware.HealthCheckMiddleware",
    ...
    "learning.timezone_middleware.UserTimezoneMiddleware",
...
OPENAI_WORD_REFRESH_MODEL = os.getenv("OPENAI_WORD_REFRESH_MODEL", "").strip() or OPENAI_QUESTION_MODEL
OPENAI_WORD_REFRESH_REASONING_EFFORT = os.getenv("OPENAI_WORD_REFRESH_REASONING_EFFORT", "").strip() or OPENAI_REASONING_EFFORT
...
OPENAI_REALTIME_TRANSCRIPTION_MODEL = os.getenv("OPENAI_REALTIME_TRANSCRIPTION_MODEL", "gpt-4o-mini-transcribe").strip() or "gpt-4o-mini-transcribe"
...
AI_USAGE_WEEKLY_ELEVENLABS_MUSIC_SECONDS = int(os.getenv("AI_USAGE_WEEKLY_ELEVENLABS_MUSIC_SECONDS", "60"))
ELEVENLABS_MUSIC_QUOTA_SECONDS_PER_GENERATION = int(os.getenv("ELEVENLABS_MUSIC_QUOTA_SECONDS_PER_GENERATION", "15"))
