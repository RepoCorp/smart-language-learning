...
def build_realtime_conversation_instructions(
    *,
    ...
    return (
        ...
        f"If the learner's message is wholly or mostly in {source_name} and is not explicitly asking for help, do not answer or continue its substantive content. Briefly acknowledge that you understand, in {target_name}, and invite the learner to say the same thing in {target_name}.\n"
        f"If the learner explicitly asks for help in {source_name}, give only brief practical help, then invite a simple reply in {target_name}. Do not use the help request to continue the substantive conversation.\n"
        f"Messages in {source_name} never count as progress toward the learner's conversation goal.\n"
