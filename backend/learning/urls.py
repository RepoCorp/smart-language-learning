...
urlpatterns = [
    ...
    path(
        "content/items/<int:item_id>/conversation/user-translation",
        ContentItemConversationUserTranslationView.as_view(),
        name="content-item-conversation-user-translation",
    ),
    path(
        "content/items/<int:item_id>/conversation/user-correction",
        ContentItemConversationUserCorrectionView.as_view(),
        name="content-item-conversation-user-correction",
    ),
