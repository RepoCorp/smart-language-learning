...
PHRASE_GRAMMAR_FEATURES_PROMPT = _load("phrase_grammar_features.txt")
STRATEGY_PERSONALIZE_TRANSLATION_PROMPT = _load("strategy_personalize_translation.txt")
STRATEGY_ACT_EXERCISE_PROMPT = _load("strategy_act_exercise.txt")
STRATEGY_COMPARE_WORDS_PROMPT = _load("strategy_compare_words.txt")
STRATEGY_RELATED_WORDS_PROMPT = _load("strategy_related_words.txt")
STRATEGY_DECODE_ANALYSIS_PROMPT = _load("strategy_decode_analysis.txt")
STRATEGY_ENCOUNTER_SITUATIONS_PROMPT = _load("strategy_encounter_situations.txt")
STRATEGY_PRACTICE_PHRASES_PROMPT = _load("strategy_practice_phrases.txt")
STRATEGY_VISUALIZE_PHRASE_PROMPT = _load("strategy_visualize_phrase.txt")
STRATEGY_VISUALIZE_IMAGE_PROMPT = _load("strategy_visualize_image_prompt.txt")
STRATEGY_WALK_SENTENCES_PROMPT = _load("strategy_walk_sentences.txt")
STRATEGY_SING_LYRIC_PROMPT = _load("strategy_sing_lyric.txt")
STRATEGY_SING_PHRASE_LYRIC_PROMPT = _load("strategy_sing_phrase_lyric.txt")
...
WORD_EXERCISES_NOUN_GERMAN_COMMON_PROMPT = _load("word_exercises_noun_german_common.txt")
WORD_EXERCISES_NOUN_GERMAN_NOMINATIVE_PROMPT = _load("word_exercises_noun_german_nominative.txt")
WORD_EXERCISES_NOUN_GERMAN_ACCUSATIVE_PROMPT = _load("word_exercises_noun_german_accusative.txt")
WORD_EXERCISES_NOUN_GERMAN_DATIVE_PROMPT = _load("word_exercises_noun_german_dative.txt")
WORD_EXERCISES_NOUN_GERMAN_GENITIVE_PROMPT = _load("word_exercises_noun_german_genitive.txt")
